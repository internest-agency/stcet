          ...
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:gap-16 xl:gap-24">
            ...
            <div>
              ...
              <h2
                ...
                "
              >
                Computing is at the heart of today&apos;s digital world.
              </h2>
            </div>
            ...
            <div className="overview-content">
              <p className="text-[14px] leading-6 text-gray-500 sm:text-[15px] sm:leading-7 lg:text-[17px] lg:leading-8">
                Computer Science is at the heart of today&apos;s digital world.
                Software, cloud platforms, mobile applications, cybersecurity,
                artificial intelligence and digital services all depend on
