...
export default function ITLearning() {
          ...
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-end lg:gap-16 xl:gap-24">
            <div>
              ...
              <h2
                ...
                "
              >
                Build your foundation in information technology.
              </h2>
            </div>
            ...
            <div>
              <p className="curriculum-intro max-w-xl text-[14px] leading-6 text-gray-500 sm:text-[15px] sm:leading-7 lg:text-[17px] lg:leading-8">
                The programme progresses from programming and data structures to
                databases, web technologies, software engineering, networking,
