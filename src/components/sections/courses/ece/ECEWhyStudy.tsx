...
const reasons = [
  {
    number: "01",
    title: "Strong Foundation in Electronics & Communication",
    description:
      "Build a strong foundation across core electronics and communication engineering concepts.",
  },
  {
    number: "02",
    title: "Hardware & Software Integration",
    description:
      "Gain exposure to the integration of hardware and software in modern electronic systems.",
  },
  {
    number: "03",
    title: "Practical Application",
    description:
      "Develop practical knowledge by connecting engineering concepts with real-world applications.",
  },
  {
    number: "04",
    title: "Emerging Technologies",
    description:
      "Explore emerging technologies shaping connected devices, communication and intelligent systems.",
  },
  {
    number: "05",
    title: "Broad Career Pathways",
    description:
      "Build skills that support career opportunities across core electronics and technology sectors.",
  },
];
...
export default function ECEWhyStudy() {
  ...
  useLayoutEffect(() => {
    ...
    const context = gsap.context(() => {
       ...
       * MAIN HEADING
       *
       * SplitText + rotation + vertical reveal
       * ==========================================
       */
       ...
       * REASON ITEMS
       *
       * Horizontal reveal + number scale
       * ==========================================
       */
          ...
          <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20 xl:gap-28">
            ...
            <div className="lg:sticky lg:top-28 lg:self-start">
              ...
              <h2
                ...
                "
              >
                Understand the technology behind the connection
              </h2>
              ...
              <p
                ...
                "
              >
                Build a strong foundation in electronics and communication while
