...
export default function CSEAIWhyStudy() {
          ...
          <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20 xl:gap-28">
            ...
            <div className="lg:sticky lg:top-28 lg:self-start">
              ...
              <h2
                ...
                "
              >
                Build the skills to shape the future of intelligent technology.
              </h2>
              ...
              <p
                ...
                "
              >
                Develop a strong foundation in computer science while building
                specialised knowledge and practical skills in artificial
            ...
            <div className="border-t border-gray-200">
              {reasons.map((reason) => (
                ...
                >
                  ...
                  {/* Optional row reveal line */}
                  <span
                    data-reason-line
                    aria-hidden="true"
                    className="pointer-events-none absolute bottom-0 left-0 h-px w-full origin-left bg-gray-200"
                  />
                </article>
              ))}
            </div>
