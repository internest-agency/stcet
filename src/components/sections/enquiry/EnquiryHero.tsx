    ...
    <section ref={sectionRef} className="relative overflow-hidden bg-gray-50">
      <Container className="py-16 sm:py-20 lg:py-28">
        ...
        <div className="grid gap-10 lg:grid-cols-[0.7fr_1.3fr] lg:gap-20">
          <div className="enquiry-hero-label">
          ...
          <div>
            <h1 className="enquiry-hero-heading max-w-4xl text-4xl font-extrabold uppercase leading-[1.02] tracking-[-0.045em] text-primary-700 sm:text-5xl lg:text-6xl xl:text-7xl">
              Begin Your
              <br />
              Engineering
              <br />
            ...
            <div className="enquiry-hero-copy mt-8 max-w-3xl">
              <p className="text-lg leading-8 text-gray-600 sm:text-xl sm:leading-9">
                Fill in the enquiry form to share your details, academic
                information and course preferences with STCET.
              </p>
            </div>
          </div>
        </div>
